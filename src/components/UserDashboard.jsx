    ...
    return (
        <section className='w-full overflow-scroll flex flex-col gap-5 scrollbar-hide'>
            ...
            <div className='flex gap-5 flex-wrap'>
                <div className='bg-gray-500/90 text-white h-25 w-full md:w-60 md:h-23 flex flex-col items-center gap-1 p-3 rounded-md'>
                ...
                <div className='bg-green-500/80 text-shadow-sm text-white h-25 w-full md:w-60 md:h-23  flex flex-col items-center gap-1 p-3 rounded-md'>
                ...
                <div className='bg-red-500/90 text-white h-25 w-full md:w-60  md:h-23 flex flex-col items-center gap-1 p-3 rounded-md'>
